# *****************************************************************************
# * VOCÊ NÃO PRECISA MODIFIFICAR ESTE ARQUIVO
# *
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Uso: python -m src.tsp_timer <numero_de_pontos>")
        return
    ...
    try:
        ...
        stdout.println("Comprimento do ciclo = " + str(length1))
        stdout.println("Inserção pelo vizinho mais próximo: " + str(elapsed1) + " segundos")
        stdout.println()
